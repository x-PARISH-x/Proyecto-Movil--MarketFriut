...
public class LoginadminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alertDialog=new AlertDialog.Builder(LoginadminActivity.this).create();
        ...
        enviarnumero.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(phoneNumber)){
                    Toast.makeText(LoginadminActivity.this, "Ingrese tu numero primero ....", Toast.LENGTH_SHORT).show();
                }else{
        ...
        enviarcodigo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(VerificaionCode)){
                    Toast.makeText(LoginadminActivity.this, "Ingrese el codigo recibido", Toast.LENGTH_SHORT).show();
                }else{
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken token) {
                ...
                alertDialog.dismiss();
                Toast.makeText(LoginadminActivity.this,"Codigo Enviado Exitosamente,Revisa tu bandeja de entrada", Toast.LENGTH_SHORT).show();
                numero.setVisibility(View.GONE);
                enviarnumero.setVisibility(View.GONE);
